...
import { resolveBuilding, termCalendar, parkingSchema, buildings } from './lib/campus.mjs';
...
if (unresolved.length) {
  ...
  out.push(`  Only ${buildings().length} of FSU's buildings ship with this plugin; see DATA-GAPS.md section 4.`);
}
out.push('');
