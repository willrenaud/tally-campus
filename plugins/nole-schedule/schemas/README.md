...
`${CLAUDE_PLUGIN_DATA}` resolves to `~/.claude/plugins/data/nole-schedule-tally-campus/`. Per the
...
Schemas are identified under `https://tally-campus.example/schemas/v0/`. The `.example` TLD is
